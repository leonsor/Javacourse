 ...
 * Date: July 17, 2015
 * */
public class EarthquakeCityMapSketch extends PApplet {
	...
	public void setup() {		//changed setup() to settings()
	...
	public static void main(String[] args){
		...
		EarthquakeCityMapSketch EarthquakeMap = new EarthquakeCityMapSketch();
		PApplet.runSketch(processingArgs, EarthquakeMap);
	}
}
