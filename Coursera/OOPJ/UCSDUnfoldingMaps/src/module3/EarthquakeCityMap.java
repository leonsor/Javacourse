...
public class EarthquakeCityMap extends PApplet {
	...
	// Above this threshold is a heavy earthquake	
	public final int SEVERE = color(255,0,0); //red	
	...
	public void setup() {
    	...
    	//int i = 1; //TODO test line only
	    for(PointFeature p : earthquakes) {
	    	SimplePointMarker s = createMarker(p);
	    	markers.add(s);
	    	//System.out.println("marker nr " + i + " added");//TODO test line only
	    	//System.out.println(p.properties.toString());
	    	//i++; //TODO test line only
	    }
	    //System.out.println("Total amount of markers added: " + markers.size()); //TODO test line only - delete after check
